...
def parse_args():
    ...
    parser.add_argument("--image_dir", type=str,default="./testImage")
    parser.add_argument("--det_algorithm", type=str, default='DB')
    parser.add_argument("--det_model_dir", type=str,default="../model/ch_ptocr_server_v2.0_det_infer.pth")
    ...
    parser.add_argument("--rec_model_path", type=str,default = "/home/yushilin/workspace/cutQuestion/ppocr/model/ch_ptocr_server_v2.0_rec_infer.pth")
    ...
    parser.add_argument(
        ...
        default=os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))),
                             'torchocr/ppocr/utils/ppocr_keys_v1.txt'))
    ...
    parser.add_argument("--rec_yaml_path", type=str, default="config/rec/rec_r34_vd_none_bilstm_ctc.yml")
