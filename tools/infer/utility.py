...
def parse_args():
    ...
    parser.add_argument("--rec_model_path", type=str, default='output/rec_chinese_common_loss/best_accuracy.pth')
    # parser.add_argument("--rec_model_path", type=str, default='output/rec/best_accuracy_attn_smooth_0.868.pth')
    ...
    parser.add_argument("--rec_yaml_path", type=str,
                        default='config/rec/ch_ppocr_v2.0/okay_ocr_crnn.yml')
    parser.add_argument("--rec_char_dict_path", type=str, default='./ppocr/utils/ppocr_keys_v1.txt')
    parser.add_argument("--use_space_char", type=bool, default=True)
    parser.add_argument("--drop_score", type=float, default=0.5)
    parser.add_argument("--char_position", type=float, default=False)
...
# def create_predictor(mode,model_path,yaml_path,logger):
#
