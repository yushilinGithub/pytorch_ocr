...
class TextDetector(BaseOCRV20):
    def __init__(self, args, **kwargs):
        ...
        super(TextDetector, self).__init__(network_config['Architecture'], **kwargs)
        print('设备标识是：', args.device)
        self.load_pytorch_weights(self.weights_path, device=args.device)
        self.net.eval()
